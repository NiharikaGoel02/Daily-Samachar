    ...
    return (
      <div>
        ...
        <Routes>
          ...
          <Route exact path="/entertainment" element={<News setProgress={this.setProgress} apikey={this.apikey} key="entertainme" pageSize= {this.pageSize} country="us" category="entertainment"/>}></Route>
